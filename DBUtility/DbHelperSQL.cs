...
namespace DBUtility
{
    public abstract class DbHelperSQL
    {
        ...
        public static void Insert(DataTable dataTable, int batchSize = 10000)
        {
            ...
            SqlBulkCopy bulkCopy = new SqlBulkCopy(connectionString, SqlBulkCopyOptions.UseInternalTransaction);//在事务中运行
